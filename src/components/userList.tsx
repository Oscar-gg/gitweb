        ...
        <div className="px-4 py-4">
          ...
          <div className="flex">
            <div className="mr-2 flex justify-end">
              <img
                className="-mr-2 h-10 w-10 rounded-full border-2 border-white "
              ...
              <img
                ...
                alt=""
              />
              <span className="flex h-10 w-10 items-center justify-center rounded-full border-2 border-gray-200 bg-white text-sm font-semibold text-gray-800 ">
                +999
              </span>
            </div>
          </div>
